...
class Custom_Meta_Simple_Input{ 
    ...
    <?php
        ...
        woocommerce_wp_text_input(array(
            ...
            'label' => __('Unit Purchase Price', 'Peleman_Editor_Communicator') . $currencySuffix,
            'value' =>  $Base_Meta->get_cartPrice(),
            'desc_tip' => true,
            'description' => __('The price of the unit total that will be added to cart. This is used in conjunction with UNIT AMOUNT.', 'Peleman_Editor_Communicator'),
